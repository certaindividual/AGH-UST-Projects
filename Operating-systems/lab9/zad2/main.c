...
sem_t counting_sem;
sem_t buff_state_sem;
sem_t buffNotEmpty_sem;
sem_t buffIsNotFull_sem;
...
int main(int argc, char *argv[]) {
	...
	*/
    ...
    sem_init(&buffNotEmpty_sem, 0, 0);
    sem_init(&buffIsNotFull_sem, 0, n);
...
void funAtExit() {	
	...
	sem_destroy(&buffIsNotFull_sem);
	sem_destroy(&buffNotEmpty_sem);
}